...
abstract final class AppColors {
  ...
  static const muted = Color(0xFF6B7191); // ikincil metin
  static const faint = Color(0xFF9BA0BC); // en soluk metin/ikon
  static const line = Color(0xFFE6E6F2); // kenarlık
  static const lineStrong = Color(0xFFD3D5E6);

  // Marka / aksan
  static const grape = Color(0xFF7A5CFF); // birincil
  ...
  // Anlamsal (aksan hue'sundan ayrı)
  static const success = Color(0xFF12B981); // doğru / tamam
  static const danger = Color(0xFFEA5A72); // yanlış / hata
